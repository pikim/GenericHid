...
namespace GenericHid
{
   ...
   internal sealed partial class Hid
   {
      internal static class NativeMethods
      {
         ...
         [DllImport("hid.dll", SetLastError = true)]
         internal static extern Boolean HidD_GetManufacturerString(SafeFileHandle HidDeviceObject, Byte[] lpBuffer,
         Int32 BufferLength);

         [DllImport("hid.dll", SetLastError = true)]
         internal static extern Boolean HidD_GetProductString(SafeFileHandle HidDeviceObject, Byte[] lpBuffer,
         Int32 BufferLength);

         [DllImport("hid.dll", SetLastError = true)]
         internal static extern Boolean HidD_GetSerialNumberString(SafeFileHandle HidDeviceObject, Byte[] lpBuffer,
         Int32 BufferLength);
      }
   }
}
